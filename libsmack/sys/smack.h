 ...
 * to the kernel interface "onlycap", located wherever the smackfs is mounted
 * in the operating system. Setting empty list causes CAP_MAC_ADMIN &
 * CAP_MAC_OVERRIDE to be unconstrained by any specific Smack label.
 *
